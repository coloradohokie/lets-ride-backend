...
mike = User.create(email: 'coloradohokie@gmail.com', password_digest: "#{User.digest('password')}", username: 'Mike', city: 'Denver', state: 'Colorado')
doug = User.create(email: 'doug@flatiron.com', password_digest: "#{User.digest('password')}", username: 'Doug', city: 'Denver', state: 'Colorado')
ahmed = User.create(email: 'ahmed@flatiron.com', password_digest: "#{User.digest('password')}", username: 'Ahmed', city: 'Denver', state: 'Colorado')
...
doug_moto1 = Motorcycle.create(make: "Honda", model: "Goldwing", year: "2000", rider_id: doug.id)
mike_moto1 = Motorcycle.create(make: "BMW", model: "RS 1200", year: "2017", rider_id: mike.id)
mike_moto2 = Motorcycle.create(make: "Kawasaki", model: "Vulcan", year: "2012", rider_id: mike.id)
ahmed_moto1 = Motorcycle.create(make: "Moto Guzzi", model: "CR12", year: "1988", rider_id: ahmed.id)
...
RideAttendance.create(rider_id: mike.id, ride_id: ride1.id)
RideAttendance.create(rider_id: doug.id, ride_id: ride1.id)

RideAttendance.create(rider_id: mike.id, ride_id: ride2.id)
RideAttendance.create(rider_id: ahmed.id, ride_id: ride2.id)

RideAttendance.create(rider_id: doug.id, ride_id: ride3.id)
RideAttendance.create(rider_id: mike.id, ride_id: ride3.id)
RideAttendance.create(rider_id: ahmed.id, ride_id: ride3.id)