...
route1 = Route.create(name: "Idaho Springs Loop Through Central City", description: "A loop starting and ending in Idaho Springs, through the central Coloado mountains", start_location:"Idaho Springs", end_location:"Idaho Springs", map_url:'<iframe src="https://www.google.com/maps/embed?pb=!1m44!1m12!1m3!1d49066.866420780876!2d-105.50315577697855!3d39.769311637955425!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m29!3e0!4m3!3m2!1d39.7418383!2d-105.51697759999999!4m3!3m2!1d39.7635487!2d-105.5269519!4m3!3m2!1d39.7754908!2d-105.5371481!4m3!3m2!1d39.8003947!2d-105.51238599999999!4m3!3m2!1d39.776237099999996!2d-105.4564285!4m3!3m2!1d39.7536576!2d-105.4021703!4m3!3m2!1d39.741926899999996!2d-105.5162807!5e0!3m2!1sen!2sus!4v1581638393609!5m2!1sen!2sus" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen=""></iframe>')
...
photo1 = Photo.create(image_url: "https://www.youmotorcycle.com/wp-content/uploads/Million-Dollar-Highway-Colorado-Motorcycle-Ride.jpg", ride_id: ride1.id, user_id: user1.id)
photo2 = Photo.create(image_url: "https://atime2ride.com/wp-content/uploads/colorado-motorcycle-tours.jpg", ride_id: ride1.id, user_id: user1.id)
photo3 = Photo.create(image_url: "https://www.roadrunner.travel/wp/wp-content/uploads/mWlNB6-LJD60AeqYenIYdsvRie1dc54ewsa2ennTedM.jpg", ride_id: ride1.id, user_id: user1.id)
photo4 = Photo.create(image_url: "https://ridermagazine.com/wp-content/uploads/2018/03/16-Hwy149.jpg", ride_id: ride1.id, user_id: user1.id)
photo5 = Photo.create(image_url: "https://learnandserve.org/wp-content/uploads/9ffa672ce74606907833f5da75d472e7-colorado-adventure-1.jpg", ride_id: ride1.id, user_id: user2.id)
photo6 = Photo.create(image_url: "https://www.colorado.com/sites/default/files/styles/media-player-large/public/Motorcycle1_NearLakeCity_PR_Colorado%20Mountain%20Moto.jpg?itok=yl3tZo93", ride_id: ride2.id, user_id: user2.id)
photo7 = Photo.create(image_url: "https://www.youmotorcycle.com/wp-content/uploads/Million-Dollar-Highway-Colorado-Motorcycle-Ride.jpg", ride_id: ride2.id, user_id: user3.id)
photo8 = Photo.create(image_url: "https://secure.meetupstatic.com/photos/member/e/9/0/3/highres_277619651.jpeg", ride_id: ride2.id, user_id: user3.id)
photo9 = Photo.create(image_url: "https://www.blochchapleau.com/wp-content/uploads/2011/10/colorado-motorcycle-accident-lawyer.jpg", ride_id: ride2.id, user_id: user3.id)
